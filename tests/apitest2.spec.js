...
//We login once to intercept login related data - we use browser level hence.
test.beforeAll(async ({ browser }) => {
  ...
  //Save the storage data in the form of a json file
  await context.storageState({ path: 'state.json' });

  //Create a new context injecting the existing storage data
